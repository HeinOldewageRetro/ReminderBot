...
func (gc *GoogleCalender) Handler(handler func(interfaces.Message)) {
	gc.handler = handler
}
...
func (gc *googleEvent) Target() []string {
	//Maybe set this per calender?
	return make([]string, 0)
}

func (gc *googleEvent) Country() string {
	//Parse this using maps?
	return gc.event.Location
}
